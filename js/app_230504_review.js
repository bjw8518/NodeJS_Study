...
app.get('/project_1', function(req,res){
  res.sendfile("./html/web_05_11/project_1.html")
});

app.get('/project_2', function(req,res){
  res.sendfile("./html/web_05_11/project_2.html")
});

app.get('/project_3', function(req,res){
  res.sendfile("./html/web_05_11/project_3.html")
});

app.get('/project_4', function(req,res){
  res.sendfile("./html/web_05_11/project_4.html")
});
